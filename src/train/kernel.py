...
class GaussianKernel(BaseKernel):
    def __init__(
        ...
        self._left_notch, self._right_notch, self._smoothing_width = wrap_tensors(left_notch, right_notch, smoothing_width)
    ...
    def shifted_gaussian(self, x: torch.tensor, shift: torch.tensor) -> torch.tensor:
        ...
        """
        x, shift, smooth_std = wrap_tensors(x, shift, self.std)
