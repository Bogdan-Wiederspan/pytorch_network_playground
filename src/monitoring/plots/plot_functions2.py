...
# @register_plot("bin_edges", requires={"bin_edges"})
# def edges_number_line(values, show=False):
...
# def dummy() -> tuple[plt.Figures, plt.Axes]:
#     """
...
# @register_plot("network_prediction", requires=None)
